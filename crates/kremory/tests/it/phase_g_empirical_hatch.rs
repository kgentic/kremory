...
//!   --test it phase_g_empirical_hatch:: -- --ignored --nocapture
//! ```
//!
//! ## ADR references
//!
...
/// cargo test -p kremory --features llm-integration,ner \
///   --test it phase_g_empirical_hatch:: -- phase_g_gemma4_e2b_pre_post_dream --ignored --nocapture
/// ```
...
///   --test it phase_g_empirical_hatch:: -- phase_g_cloud_llm_gate --ignored --nocapture
/// ```
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
