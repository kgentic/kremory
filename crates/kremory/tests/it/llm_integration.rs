...
//!   cargo test -p kremory --features llm-integration --test it llm_integration:: -- --ignored
//!
...
use crate::helpers::metrics_capture::MetricsCapture;
...
async fn with_llm_tracked_emits_chat_metrics() {
    use crate::helpers::mock_chat::{MockBehavior, MockChatProviderTracking};
