...
//! cargo test -p kremory --features llm-integration --test it label_canonical_assertion:: -- --ignored --nocapture
//! ```
//!
...
/// cargo test -p kremory --features llm-integration --test it label_canonical_assertion:: \
