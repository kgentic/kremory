...
#[ignore = "lemma false-merge safety corpus: requires Ollama in record mode, or a \
            ...
            --test it type_registry_collapse_lemma_false_merge_safety:: -- --ignored \
...
async fn lemma_false_merge_safety_corpus() {
    ...
    for pair in COLLISION_PAIRS {
        ...
        if cosine >= crate::type_registry_collapse_lemma_false_merge_safety::type_registry_collapse_primary_cosine() {
