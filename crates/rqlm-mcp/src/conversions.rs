...
//! rqlm core types (`rql_memory::*`).
//!
//! Per D.4 scaffold rationale (lib.rs header): the MCP-side types carry
//! `JsonSchema` derives required by rmcp's macros; rqlm-side types do
//! not (keeps rqlm free of schemars). This module is the conversion
//! boundary.
//!
//! ## Error surface
//!
