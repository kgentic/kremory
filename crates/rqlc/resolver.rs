...
use crate::config::{EntropyConfig, MinHashConfig};
use crate::error::Result;
use crate::intelligence::{EntityResolver, ExtractedEntity, ResolutionResult};
...
mod tests {
    use super::*;
    use crate::config::{EntropyConfig, MinHashConfig};
    use crate::intelligence::ExtractedEntity;
