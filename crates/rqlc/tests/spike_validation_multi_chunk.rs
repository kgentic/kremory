...
mod spike {
    ...
    use rql_core::extraction::SingleCallExtractor;
    use rql_core::intelligence::{EntityExtractor, ExtractedEntity, ExtractionContext};
    use super::common::build_llm;
    use rql_core::text_utils::{scan_proper_nouns, OovAuditor};
