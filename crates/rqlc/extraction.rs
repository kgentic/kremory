...
pub struct ProgrammaticFirstExtractor<L: ChatProvider> {
    llm: Arc<L>,
    auditor: Arc<crate::text_utils::OovAuditor>,
...
mod tests {
    use super::*;
    use crate::intelligence::ExtractionContext;
    ...
    fn load_test_auditor() -> crate::text_utils::OovAuditor {
        ...
        let stops: std::collections::HashSet<String> =
            stop_words::get(stop_words::LANGUAGE::English)
                ...
                .map(|s| s.to_string())
                .collect();
        crate::text_utils::OovAuditor::new(dict, stops)
    }
