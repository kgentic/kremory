  ...
  docsSidebar: [
    ...
    'getting-started',
    {
      ...
      items: [
        ...
        'examples/correcting-the-record',
        'examples/searching-documents',
        'examples/bulk-import',
        'examples/gdpr-erasure-by-source',
        'examples/undoing-a-bad-change',
        'examples/append-only-namespace',
        'examples/a-long-document',
        'examples/two-handles-one-database',
        'examples/ingest-without-blocking',
        'examples/deleting-and-restoring',
        'examples/changing-embedding-model',
        'examples/undoing-a-correction',
        'examples/domain-entity-types',
        'examples/dream-on-a-schedule',
        'examples/hosted-providers',
        'examples/cancelling-in-flight-work',
        'examples/who-touched-this-record',
        'examples/what-can-be-undone',
