...
Per [the observability-first-class ADR](https://github.com/kgentic/kremory/blob/main/docs/adr/adr-observability-first-class.md), label values are bounded:
...
- [Observability-first-class ADR](https://github.com/kgentic/kremory/blob/main/docs/adr/adr-observability-first-class.md) — observability as first-class concern + dual-emit policy
