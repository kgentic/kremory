...
> [`examples/serving_over_http.rs`](https://github.com/kgentic/kremory/blob/main/crates/kremory/examples/serving_over_http.rs). This mirrors
...
[`examples/two_handles_one_database.rs`](https://github.com/kgentic/kremory/blob/main/crates/kremory/examples/two_handles_one_database.rs)).
...
[`examples/serving_over_http.rs`](https://github.com/kgentic/kremory/blob/main/crates/kremory/examples/serving_over_http.rs) shows this
shape end to end, and [`examples/ingest_without_blocking.rs`](https://github.com/kgentic/kremory/blob/main/crates/kremory/examples/ingest_without_blocking.rs)
