...
This mirrors [`crates/kremory/examples/quickstart.rs`](https://github.com/kgentic/kremory/blob/main/crates/kremory/examples/quickstart.rs)
...
yourself on the results. See [the audit-query section](./api.md#audit-query) for the worked
...
See [ADR-003](https://github.com/kgentic/kremory/blob/main/docs/adr/adr-003-bitemporal-audit-compliance.md).
...
12. Migration guide (currently covers up to v0.3.2 — see [CHANGELOG](https://github.com/kgentic/kremory/blob/main/crates/kremory/CHANGELOG.md) for changes since)
13. Feature flags
...
> [`docs/decisions/dream-keep-or-cut-prereg.md`](https://github.com/kgentic/kremory/blob/main/docs/decisions/dream-keep-or-cut-prereg.md).
...
breakdown, and reproduction steps: [`docs/benchmarks.md`](./benchmarks.md).
...
[`docs/benchmarks.md`](./benchmarks.md) for the full writeup, including what was tried and
ruled out.
...
changes — pin a minor (`kremory = "0.7"`) and read the [CHANGELOG](https://github.com/kgentic/kremory/blob/main/CHANGELOG.md) before bumping.
